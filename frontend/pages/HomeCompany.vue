<template>
  <div class="q-ma-lg">
    <div class="q-my-lg">
      ...
      <div class="text-body1">Happy to see searching for talents</div>
    </div>
    <div class="flex-center row">
      <q-card class="q-mb-md bg-secondary" style="max-width: 1200px" bordered>
        ...
        <q-form class="q-mx-xl q-my-md row q-col-gutter-md">
          ...
          <q-input class="col-12" outlined label="Description" />
          <q-input class="col-12" outlined label="Ideal Candidate" />
          <q-select
            v-model="model"
            class="col-4"
            square
...
options.value = ["JS", "TS", "HTML", "CSS", "C", "C++", "C#"];
</script>
